...
export function HomePage() {
  ...
  <p class="font-sans text-sm font-semibold tracking-widest uppercase mb-3" style="color: rgb(200, 146, 42);">Thương Hiệu Yến Sào Uy Tín</p>
  <h1 class="font-sans text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight text-balance">Yến Sào Mười Thiết<br><span style="color: rgb(240, 192, 96);">Đào Đào</span></h1>
  <p class="font-sans text-base md:text-lg text-white/85 mb-8 leading-relaxed max-w-xl">Sản phẩm yến sào cao cấp 100% nguyên chất, thu hoạch tự nhiên — bổ dưỡng cho cả gia đình.</p>
  <button class="inline-flex items-center gap-2 font-bold py-3 px-8 rounded-lg transition-all hover:scale-105" style="background-color: rgb(200, 146, 42); color: rgb(255, 255, 255);">Xem Sản Phẩm<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right w-5 h-5" aria-hidden="true"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg></button>
</div>
        </div>
      </section>
