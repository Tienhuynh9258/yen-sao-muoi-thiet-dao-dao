        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-3 hover:opacity-90 transition-opacity flex-shrink-0 relative z-20">
              <div className="relative -mb-14 logo-glow-wrap">
                <Image
                  src="/logo_transparent.png"
                  alt="Yến Sào Mười Thiết Đào Đào"
                  width={80}
                  height={80}
                  className="h-20 w-20 object-contain custom-logo-shadow"
                  priority
                />
              </div>
              <div className="hidden sm:block text-left">
                <div className="font-sans font-bold text-lg leading-tight tracking-wide" style={{ color: '#8b1a1a' }}>
                  Yến Sào Mười Thiết
                </div>
                <div className="font-sans font-semibold text-sm tracking-wider" style={{ color: '#c8922a' }}>
                  Đào Đào
                </div>
              </div>
            </Link>
